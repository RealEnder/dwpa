...
$mysql->query("UPDATE stats SET pvalue = (SELECT count(1) FROM nets) WHERE pname='nets'");
...
$mysql->query("UPDATE stats SET pvalue=(SELECT count(1) FROM nets WHERE ts >= DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 1 DAY)) WHERE pname='24sub'");
